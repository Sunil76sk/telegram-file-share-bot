...
async def referral_command_handler(client: Client, message: Message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🎁 Redeem 3 Days Premium (5 pts)", callback_data="redeem_prem_3d"
                )
            ],
            [
                InlineKeyboardButton(
                    "🎁 Redeem 7 Days Premium (10 pts)", callback_data="redeem_prem_7d"
                )
            ],
            [
                InlineKeyboardButton(
                    "🎁 Redeem 30 Days Premium (30 pts)",
                    callback_data="redeem_prem_30d",
                )
            ],
            [
                InlineKeyboardButton(
                    "📢 Share Referral Link",
                    url=f"https://t.me/share/url?url={ref_link}&text=Hey!%20Check%20out%20this%20Telegram%20File%20Share%20Bot!",
                )
            ],
        ]
    )
